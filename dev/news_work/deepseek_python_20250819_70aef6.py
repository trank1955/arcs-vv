...
def generate_news_json_from_html():
    ...
    for html_file in html_dir.glob("*.html"):
        try:
            ...
            # Estrai contenuto CORRETTO (dopo il tag <hr>)
            full_content = None
...
class EditPostDialog(tk.Toplevel):
    ...
    def browse_image(self):
        initial_dir = Path("..", "immagini").resolve()
    ...
    def save(self):
        ...
        img_path = Path("..", "immagini", data['image'])
...
class BlogManagerApp:
    def __init__(self, root):
        ...
        self.root.geometry("1000x700")  # Finestra più grande
        ...
        self.tab_backups = ttk.Frame(self.notebook)  # Nuova tab per i backup
        
        self.notebook.add(self.tab_posts, text="Gestione News")
        self.notebook.add(self.tab_log, text="Log")
        self.notebook.add(self.tab_backups, text="Backup")  # Aggiunta nuova tab
